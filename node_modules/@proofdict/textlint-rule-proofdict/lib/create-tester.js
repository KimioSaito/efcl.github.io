...
exports.getDictionary = exports.createTester = undefined;
 ...
 */
var createTester = exports.createTester = function createTester(_ref) {
 ...
 * @returns {*}
 */
var getDictionary = exports.getDictionary = function getDictionary(options, mode) {
    // prefer `dictionary` option
    if (options.proofdict !== undefined) {
        return options.proofdict;
    }
    var proofDictData = void 0;
    // NETWORK
